...
ActiveRecord::Schema[8.1].define(version: 2026_09_21_174501) do
  ...
  create_table "category_goals", id: :uuid, default: -> { "uuidv7()" }, force: :cascade do |t|
    ...
    t.index ["category_id", "month", "year"], name: "index_category_goals_on_category_id_and_month_and_year", unique: true
    t.check_constraint "month >= 1 AND month <= 12", name: "category_goals_month_range"
    t.check_constraint "value >= 0::numeric", name: "category_goals_value_non_negative"
    t.check_constraint "year >= 1 AND year <= 9999", name: "category_goals_year_range"
  end
  ...
  create_table "monthly_statuses", id: :uuid, default: -> { "uuidv7()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "last_processed_at"
    t.integer "month", null: false
    t.boolean "processing", default: false, null: false
    t.enum "status", default: "open", null: false, enum_type: "monthly_status"
    t.datetime "updated_at", null: false
    t.uuid "user_id", null: false
    t.integer "year", null: false
    t.index ["status", "year", "month"], name: "index_monthly_statuses_on_status_and_year_and_month"
    t.index ["user_id", "month", "year"], name: "index_monthly_statuses_on_user_id_and_month_and_year", unique: true
  ...
  create_table "notifications", id: :uuid, default: -> { "uuidv7()" }, force: :cascade do |t|
    ...
    t.index ["user_id", "kind", "notifiable_type", "notifiable_id", "dedup_key"], name: "index_notifications_on_unread_dedup", unique: true, where: "((read = false) AND (dedup_key IS NOT NULL))", nulls_not_distinct: true
    t.index ["user_id"], name: "index_notifications_on_user_id_unread", where: "(read = false)"
  end

  create_table "tag_goals", id: :uuid, default: -> { "uuidv7()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "month", null: false
    ...
    t.decimal "value", precision: 15, scale: 2, null: false
    t.integer "year", null: false
    t.index ["tag_id", "month", "year"], name: "index_tag_goals_on_tag_id_and_month_and_year", unique: true
    t.check_constraint "month >= 1 AND month <= 12", name: "tag_goals_month_range"
    t.check_constraint "value >= 0::numeric", name: "tag_goals_value_non_negative"
    t.check_constraint "year >= 1 AND year <= 9999", name: "tag_goals_year_range"
  end
  ...
  add_foreign_key "category_goals", "categories"
  ...
  add_foreign_key "tag_goals", "tags"
