...
Rails.application.configure do
  ...
  # Skip http-to-https redirect for the default health check endpoint (Docker HEALTHCHECK).
  ...
  config.action_mailer.ses_v2_settings = {
    region: ENV["AWS_REGION"].presence || Rails.application.credentials.dig(:aws, :region)
  }
  config.action_mailer.default_url_options = {
    host: ENV["APP_HOST"].presence || Array(Rails.application.credentials.dig(:hosts)).compact_blank.first,
    protocol: "https"
  }
