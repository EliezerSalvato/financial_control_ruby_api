class MonthlyStatement::Transfer::Record < ApplicationRecord
  self.primary_key = "id"
  self.inheritance_column = nil

  LISTING_SQL = File.read(File.expand_path("../listing_transfers.sql", __dir__))
  ...
  attribute :source_account_name, :string
  attribute :source_account_brand, :string
  attribute :destination_account_id, :string
  attribute :destination_account_name, :string
  attribute :destination_account_brand, :string
